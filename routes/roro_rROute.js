...
const Cargos = require("../models/roro");
...
const Dock_R = require("../models/roro_Model");
const async = require('async');
const moment = require('moment');


//show route
router.get("/roro_r", function(req, res) {
        ...
        async.parallel([
            ...
            Dock_R.count().exec(function(err, count) {
                if (err) {
                    ...
                    return res.render("main/roroRecipt", {
...
router.post("/_update_cargo_dock_1_/roro", function(req, res) {
...
router.post("/_update_cargo_dock_3_/roro", function(req, res) {
    //search to get the cargo id
    Cargos.findOne({ _id: req.body.data.cargo_id_11 }, function(err, foundData) {
        // console.log(foundData.Cars.length);
        //update cars weight
...
router.post("/_update_cargo_dock_2_/roro", function(req, res) {
    //search to get the cargo id
    Cargos.findOne({ _id: req.body.data.cargo_id_11 }, function(err, foundData) {
...
//create dock_receipt
router.post("/roro_r/new", function(req, res) {
...
router.get("/roro/:id/fetch_perclient", function(req, res) {
...
//delete 
router.delete("/roro_r/:id/delete", function(req, res) {
...
//dock receipt
router.get("/r_r/:id/editRoute", function(req, res) {
    ...
    if (req.user) {
        ...
        Dock_R
            ...
            .exec(function(err, foundData) {
                //  console.log(foundData);
                return res.render("main/r_r_edit", { title: 'Oldsailor Ocean Shipping LLC || Edit RORO Receipt', foundData: foundData, layout: false });
            });
...
//edit form data
router.post("/r_r/:id/edit", function(req, res) {
...
//email
router.get("/r_r/:id/email/:client_id/cargo/:cargo_id/consignee/:consignee_id/booking_c/:bc_id", function(req, res) {
    ...
    async.parallel([
        ...
        res.render("main/email_roro", { layout: false, Dock_R: Dock_R, ClientData: ClientData, BookingConfirmation: BookingConfirmation, Cargos: Cargos, Consignee: Consignee });
